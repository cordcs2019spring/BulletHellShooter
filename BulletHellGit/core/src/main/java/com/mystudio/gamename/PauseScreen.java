 ...
 */
public class PauseScreen // implements ApplicationListener
{
     ...
     */
    public PauseScreen(String texturePath, float x, float y, int xSpeed, int ySpeed){
